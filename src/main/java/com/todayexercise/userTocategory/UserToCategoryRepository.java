...
public interface UserToCategoryRepository extends JpaRepository<UserToCategory, Integer> {
    ...
    @Query(value = "INSERT INTO user_category(user_index, category_id) VALUES(:user_index, :category_id)", nativeQuery = true)
    void registCategory(@Param("user_index") Long user_index, @Param("category_id") Long category_id);
